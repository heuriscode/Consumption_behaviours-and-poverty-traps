get_outmat_JONES_het=function(model_list,intercept=FALSE){

#ROT
outmat=matrix(NA,nrow=14,ncol=4)
rownames(outmat)=c("diff(Mean Parish Consumption)","Std. Error",
                   "diff(Mean Parish Consumption) (+ve values)","Std. Error",
                   "", #gap
