get_outmat_ROT_het=function(model_list,intercept=FALSE){

#pbnftest(reginc_mg,test=c("bnf"))
...
outmat[15,4]=20
outmat[17,4]= round(pbnftest(model_list[[4]],test="lbi")$statistic,2)
