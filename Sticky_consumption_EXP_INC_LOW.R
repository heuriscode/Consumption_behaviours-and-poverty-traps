...
write.table(persist_mat,"results\\income persistence results_LOW.csv",sep=",")
...
write.table(caus_mat,"results\\causality results_LOW.csv",sep=",")
...
#write tables
write.table(outmat_rot,"results\\RoT results full sample_LOW.csv",sep=",",row.names=TRUE)
write.table(outmat_habit,"results\\Habits results full sample_LOW.csv",sep=",",row.names=TRUE)
write.table(outmat_jones,"results\\Jones results full sample_LOW.csv",sep=",",row.names=TRUE)
